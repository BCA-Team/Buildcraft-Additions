...
public class WidgetFluidTank extends WidgetBase {
	...
	public WidgetFluidTank(int id, int x, int y, int u, int v, int width, int height, GuiBase gui, Tank tank, String... textures) {
	...
	public void render(int mouseX, int mouseY) {
		...
		if (tank.getFluid() != null)
			drawFluid(tank.getFluid(), ((float) this.tank.getFluid().amount / (float) (tank.getMaxCapacity()) * height), x, y, width, height);
	}
